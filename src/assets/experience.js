export const experience = [
    {
        ...
        to: "Present",
        description:
            "Led the creation of a dynamic Svelte-based VSCode plugin, fast-tracking 3rd party code integration. Developed the VSCode Sidebar, finishing a 2-week project ahead of schedule, saving 40% on timelines. Transformed the company website with animations, lazy loading, and three new pages, boosting user engagement and online presence. Streamlined processes for early investor meetings and demos.",
        tags: ["Svelte", "ReactJs", "Typescript", "REST API", "Postman"],
    },
    {
